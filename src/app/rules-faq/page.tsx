  ...
  return (
    <section className="relative min-h-screen bg-white overflow-hidden">
      ...
      <div className="flex min-h-screen">
        {/* LEFT PANEL - Static Title with White Background (1/2 width) */}
        <div className="w-1/2 relative z-[15] flex items-end overflow-visible">
          {/* White background */}
        ...
        {/* RIGHT PANEL - Scrollable Content (1/2 width) */}
        <div className="w-1/2 relative z-20 overflow-y-auto h-screen bg-white">
              ...
              {rulesData.map((rule, index) => {
                ...
                return (
                  ...
                  >
                    {/* Card Header */}
                    <motion.div 
                      className="py-12 px-4 cursor-pointer relative overflow-hidden"
                      style={{
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 grid grid-cols-5 gap-8 items-start">
                            ...
                            <div className="col-span-2">
                              <h3 
                                className="text-3xl font-black uppercase tracking-tight leading-[1.1]"
                                style={{ 
                                  fontFamily: 'Satoshi, Inter, "Helvetica Neue", sans-serif',
                                  color: hoveredCard === rule.id ? cardColor.text : "#000000"
                                }}
                              >
                                <span 
                                  className="text-lg font-mono mr-3"
                                  style={{ 
                            ...
                            <div className="col-span-3">
                              ...
                              >
                                <p 
                                  className="text-lg font-black leading-tight mb-3 uppercase tracking-wide"
                                  style={{ 
                                    color: hoveredCard === rule.id ? cardColor.text : "#000000",
                                    fontFamily: 'Satoshi, Inter, "Helvetica Neue", sans-serif',
                                    fontWeight: '900',
                          ...
                          <div className="max-w-4xl">
                            ...
                            <ul className="space-y-4">
                              {rule.details.map((detail, detailIndex) => (
                                <motion.li
                                  key={detailIndex}
                                  className="font-bold leading-relaxed flex items-start text-base"
                                  style={{ 
                                    color: cardColor.text,
                                    fontFamily: 'Satoshi, Inter, "Helvetica Neue", sans-serif',
                                    fontWeight: '700',
            ...
            <div className="mt-20 pt-12 border-t-4 border-black">
              <div className="text-center">
                ...
                <a 
                  ...
                  className="inline-flex items-center px-12 py-6 bg-black text-white font-black uppercase tracking-wider border-2 border-black hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105"
                  style={{ 
                    fontFamily: 'Satoshi, Inter, "Helvetica Neue", sans-serif',
                    fontWeight: '900',
                    fontSize: 'clamp(1rem, 1.5vw, 1.2rem)',
